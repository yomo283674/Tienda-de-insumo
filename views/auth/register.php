...
<head>
    ...
    <title>Registro | AgroStock</title>
    <!-- Bootstrap CSS -->
    ...
    <style>
        ...
        body {
            ...
            position: relative;
            padding: 40px 0;
            /* Add padding for smaller screens where card gets tall */
        }
        ...
        <div class="auth-card animate__animated animate__fadeInUp">
            ...
            <form action="../../controllers/auth/registerController.php" method="POST" id="formRegister">
                ...
                <div class="mb-4 form-check">
                    ...
                    <label class="form-check-label text-muted small" for="terms">Acepto los <a href="#"
                            class="text-accent">Términos de Servicio</a> y la <a href="#" class="text-accent">Política
                            de Privacidad</a>.</label>
                </div>

                <button type="submit" class="btn btn-primary-custom">
                    Crear Cuenta <i class="bi bi-person-plus ms-2"></i>
                </button>
            </form>

            <div class="text-center mt-4">
                <p class="text-muted mb-0">¿Ya tienes una cuenta? <a href="login.php" class="text-accent">Inicia
                        Sesión</a></p>
            </div>
        </div>
    </div>
